...
const ProductDetailsScreen: React.FC = () => {
  ...
  const images = [
    ...
    require("../../../assets/images/productpant.png"),
    require("../../../assets/images/productshirt.png"),
    require("../../../assets/images/productpant.png"),
  ];
  const selectedBrand = route.params?.brand; // Example: { name: "POSHAX", logo: require("../../../assets/brands/poshax.png") }
  ...
  const similarProducts = [
    {
      ...
      tag: "AD",
      brand: "POSHAX",
      name: "Men Relaxed Fit Cargo Joggers with Drawstring Waist",
      price: "₹1,440",
      originalPrice: "₹3,599",
      discount: "60% OFF",
      image: require("../../../assets/images/productpant.png"),
    },
    {
      id: "2",
      tag: "BESTSELLER",
      ...
      originalPrice: "₹4,549",
      discount: "70% OFF",
      image: require("../../../assets/images/productshirt.png"),
    },
  ];

  const reviews = [
    { id: "1", name: "Saimon Johnson", location: "Shrirampur, Hooghly", rating: 5 },
    { id: "2", name: "Rina Das", location: "Kolkata", rating: 4 },
    { id: "3", name: "Arjun Roy", location: "Howrah", rating: 5 },
  ];
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        <View style={{ padding: 16 }}>
          <Text style={{ fontSize: 16, fontWeight: "600", color: "#333" }}>
            {product?.name || "Men’s Brown Shirt"}
          </Text>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", marginVertical: 8 }}>
            ...
            <Text style={{ fontSize: 14, color: "red" }}>30% OFF</Text>
          </View>
        ...
        >
          ...
          >
            <Text style={{ color: "#FF6F00", fontSize: 13, fontWeight: "500" }}>Change</Text>
          </TouchableOpacity>
        </View>

          {/* 🔸 Reviews Section }
          {/* (kept unchanged — as per your logic) }
          {/* 🔹 Reviews Section }
          <View style={{ marginVertical: 16 }}>
            <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 8 }}>
              ...
              <Image
                ...
                style={{ width: 12, height: 12, marginLeft: 94 }}
                resizeMode="contain"
              />
              <Text
                style={{
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <View
                        style={{
                          width: `${(counts[i] / Math.max(...counts)) * 100}%`,
                          height: 6,
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  <Text style={{ color: "#333", fontSize: 12, lineHeight: 16 }}>
                    “The Indore Cricket Club Is Terrible! It’s Inaccessible, Untidy, And Has
          ...
          <Text style={{ fontSize: 16, fontWeight: "bold", marginTop: 20, marginBottom: 8 }}>
            Similar Products
          </Text>
...
>
  ...
  >
    <Image
      source={require("../../../assets/icons/shareActive.png")} // replace with your asset
  ...
  >
    <Image
      source={require("../../../assets/icons/Cart Inactive-1.png")} // your cart icon
      style={{ width: 18, height: 18, marginRight: 6 }}
    />
    <Text style={{ fontSize: 14, fontWeight: "600", color: "#fff" }}>Add to Cart</Text>
  </TouchableOpacity>
  ...
  >
    <Image
      source={require("../../../assets/icons/OrderHistory.png")} // your order icon
      style={{ width: 18, height: 18, marginRight: 6 }}
    />
    <Text style={{ fontSize: 14, fontWeight: "600", color: "#FF6F00" }}>Order for Try</Text>
  </TouchableOpacity>
</View>
        ...
        <View style={styles.modalBackground}>
          <View style={styles.modalContainer}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setTempAddress({ ...tempAddress, landmark: text })}
            />
            <TextInput
              placeholder="City"
              style={styles.input}
            ...
            <TextInput
              ...
              onChangeText={(text) => setTempAddress({ ...tempAddress, pincode: text })}
            />
